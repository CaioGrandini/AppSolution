...
{
    public class AtualizarNomeUsuarioCommandsHandler
    {
        private readonly IUsuarioRepository _repository;

        public AtualizarNomeUsuarioCommandsHandler(
        ...
        public async Task Handle(
            AtualizarNomeUsuarioCommands command)
        {
            var usuario =
            ...
            usuario.AlterarNome(new string(command.Nome));
